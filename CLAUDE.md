...
## 项目简介
在 V1 赛博朋克猫猫官网基础上，增加**网页碎裂特效**——点击隐藏按钮后，Canvas 绘制的赛博朋克"幕布"以碎片形式碎裂散落，露出底层的"真实网页"（白底亮色个人作品集/简历页）。用户为代码小白，所有操作需保持简单。

## 核心目标
- **打破第四面墙**：从虚拟猫猫公司 → 现实个人介绍
- **炫技展示**：Canvas 动画能力 + 3D 碎片物理 + 创意交互
- **求职利器**：可作为向 HR 展示的全栈作品案例
